...
import inbox_impl
from inbox_impl import GmailClientImpl
from inbox_api import GmailClientInterface, get_client
...
@patch("inbox_impl._impl.InstalledAppFlow.from_client_secrets_file")  
@patch("inbox_impl._impl.build")  
@patch("inbox_impl._impl.Path.exists")
...
@patch("inbox_impl._impl.Path.exists", return_value=True) 
@patch("inbox_impl._impl.Credentials.from_authorized_user_file")  
@patch("inbox_impl._impl.open", new_callable=mock_open)  
@patch("inbox_impl._impl.InstalledAppFlow.from_client_secrets_file") 
@patch("inbox_impl._impl.build") 
...
@patch("inbox_impl._impl.Path.exists", return_value=True)                     # 3rd arg
@patch("inbox_impl._impl.Credentials.from_authorized_user_file")              # 2nd arg
@patch("inbox_impl._impl.build")     
